...
public class DateUtils {
    ...
    public DateUtils(int month, int day, int year) {
        this.day = day;
        this.month = month;
        this.year = year;
    ...
    public DateUtils(int month, int day, int year, DateUtils prev1st, int prevMonthDays) {
        this.day = day;
        this.month = month;
        this.year = year;
    ...
    public String toString() {
        String retval = month + "/" + day + "/" + year + " " + DateUtils.DAYOFWEEK[dow];
        return retval;
    }
